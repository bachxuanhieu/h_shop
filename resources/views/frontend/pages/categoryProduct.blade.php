...
<div class="container-fluid bg-secondary mb-5">
    <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
        @foreach ($category as $i)
                ...
                <h1 class="font-weight-semi-bold text-uppercase mb-3">{{$i->name}}</h1>
            ...
            <div class="col-12 pb-1">
                <nav aria-label="Page navigation">
                    <ul class="pagination justify-content-center mb-3">
                        ...
                        @else
                            <li class="page-item">
                                <a class="page-link" href="{{ $categoryProducts->previousPageUrl() }}" rel="prev" aria-label="@lang('pagination.previous')">&laquo;</a>
                            </li>
                        @endif
                        @if ($categoryProducts->hasMorePages())
                            <li class="page-item">
                                <a class="page-link" href="{{ $categoryProducts->nextPageUrl() }}" rel="next" aria-label="@lang('pagination.next')">&raquo;</a>
                            </li>
                        @else
