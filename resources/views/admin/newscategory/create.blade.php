    ...
    <div class="card">
        <div class="card-header">
           <div class="row">
                ...
                <a href="{{url('/admin/newscategory')}}" class="btn btn-success btn-sm ml-auto">Quay lại</a>
           </div>
        </div>
        <section class="content">
            <div class="card-body">
            <form action="{{url('/admin/newscategory')}}" method="POST" enctype="multipart/form-data">
                @csrf
                    <div class="mb-3">
