    ...
    <div class="card">
        <div class="card-header">
           <div class="row">
                ...
                <a href="{{url('/admin/newscategory/create')}}" class="btn btn-success btn-sm ml-auto">Thêm danh mục</a>
           </div>
        </div>
        <div class="card-body">
            <table class="table table-success table-striped">
                ...
                <tbody>
                    @foreach ($newscategory as $i)
                    <tr>
                        <td>{{ $i->id }}</td>
                        <td>
                            <img src="{{asset('admin/image/newscategory/'.$i->image)}}" height="100px" width="100px" alt="">
                        </td>
                        <td>{{ $i->name }}</td>
                        <td>
